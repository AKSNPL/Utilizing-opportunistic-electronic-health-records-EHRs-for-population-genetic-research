...
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/02_step1_GWAS/Step1-%j.log.out
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/02_step1_GWAS/Step1-%j.log.err
...
export input=${current_proj}/input/03_pheno_cov_files
export step1=${current_proj}/output/05_output_step1
...
--phenoColList ${names}_ehr_md,${names}_ukb_md,${names}_ehr_median,${names}_ehr_mean,${names}_ehr_max,${names}_ehr_min \
--qt \
--threads 30 \
--bsize 1000 \
--lowmem \
