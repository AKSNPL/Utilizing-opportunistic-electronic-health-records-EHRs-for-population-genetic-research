...
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/12_GWAS_step1_EHR_only/Step1-%j.log.out
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/12_GWAS_step1_EHR_only/Step1-%j.log.err
...
export input=${current_proj}/input/07_EHR_only_phe_cov
export step1=${current_proj}/output/21_GWAS_step1_EHR_only
...
--phenoColList ${names}_ehr_median,${names}_ehr_mean,${names}_ehr_max,${names}_ehr_min \
--qt \
--threads 30 \
--bsize 1000 \
--lowmem \
