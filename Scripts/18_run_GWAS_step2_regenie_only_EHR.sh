...
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/07_GWAS_step1_indications_EHR_only/Step2-%j.log
#SBATCH --error=/Aakash/12_GWAS_EHR_UKB/logs/07_GWAS_step1_indications_EHR_only/Step2-%j.err
...
export output=${current_proj}/output/13_GWAS_step2_ind_EHR_only
