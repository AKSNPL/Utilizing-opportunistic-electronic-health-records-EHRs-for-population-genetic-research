...
#! set name
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/04_obtain_reg_sent_logs/COLLATE_ehr_only-%x-%j.out
...
cd /Aakash/12_GWAS_EHR_UKB/output/18_combined_allchrs_EHR_only
