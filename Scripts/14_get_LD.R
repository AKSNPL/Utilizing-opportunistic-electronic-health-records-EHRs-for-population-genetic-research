...
get.LD <- function(chr.s, pos.s, pos.e, pheno){
  ...
  print(paste("/Aakash/12_GWAS_EHR_UKB/scripts/14_get_dosages_LD_matrix.sh", chr.s, pos.s, pos.e, pheno))
  system(paste("/Aakash/12_GWAS_EHR_UKB/scripts/14_get_dosages_LD_matrix.sh", chr.s, pos.s, pos.e, pheno))
