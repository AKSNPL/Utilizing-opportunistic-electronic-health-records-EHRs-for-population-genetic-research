...
#SBATCH --job-name 1_GWAS
#SBATCH --partition=compute
#SBATCH --account=sc-users
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=120G
#SBATCH --array=1-23%23
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/09_GWAS_step2_indications_all/Step2-%j.log
#SBATCH --error=/Aakash/12_GWAS_EHR_UKB/logs/09_GWAS_step2_indications_all/Step2-%j.err
...
export output=${current_proj}/output/15_GWAS_step2_ind_all

names="all"

## a file from 1 ...23
chr="$(awk -v var="$SLURM_ARRAY_TASK_ID" -F '\t' 'NR == var {print $1}' /sc-projects/sc-proj-computational-medicine/people/Aakash/12_GWAS_EHR_UKB/input/04_others/chr_all.txt)"
