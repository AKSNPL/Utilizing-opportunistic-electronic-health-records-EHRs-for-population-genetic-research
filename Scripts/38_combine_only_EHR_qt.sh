...
#! set name
#SBATCH --output=/Aakash/12_GWAS_EHR_UKB/logs/99_background_others/obtain_UKB_EHR_corr-%x-%j.out
...
R_SCRIPT='/Aakash/12_GWAS_EHR_UKB/scripts/38_combine_only_EHR_qt.R'
